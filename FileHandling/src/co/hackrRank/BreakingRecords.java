...
public class BreakingRecords {
	...
	public static void main(String[] args) {
		// Sample Input
		List<Integer> scores_0 = List.of(10, 5, 20, 20, 4, 5, 2, 25, 1);
		List<Integer> scores_1 = List.of(3, 4, 21, 36, 10, 28, 35, 5, 24, 42);

		// Output the result
		System.out.println(breakingRecords(scores_0)); // Output: [2, 4]
		System.out.println(breakingRecords(scores_1)); // Output: [4, 0]
	}
}
